...
{  
	...
	TIM_TimeBaseInitTypeDef  TIM_TimeBaseStructure;
	TIM_OCInitTypeDef  TIM_OCInitStructure1,TIM_OCInitStructure2,TIM_OCInitStructure3,TIM_OCInitStructure4;
...
//	GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化GPIO
   //初始化TIM3
	...
	TIM_OC1Init(TIM3, &TIM_OCInitStructure1);  //根据T指定的参数初始化外设TIM3 OC2
